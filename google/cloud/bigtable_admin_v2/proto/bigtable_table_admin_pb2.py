...
_CREATETABLEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\002\372A\"\n bigtable.googleapis.com/Instance'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_CREATETABLEFROMSNAPSHOTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\002\372A\"\n bigtable.googleapis.com/Snapshot'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_DROPROWRANGEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\002\372A\037\n\035bigtable.googleapis.com/Table'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_SNAPSHOTTABLEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\002\372A!\n\037bigtable.googleapis.com/Cluster'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_GETBACKUPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\002\372A \n\036bigtable.googleapis.com/Backup'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_CREATEBACKUPREQUEST.fields_by_name['backup'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._BACKUP
...
_UPDATEBACKUPREQUEST.fields_by_name['backup'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._BACKUP
_UPDATEBACKUPREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTBACKUPSRESPONSE.fields_by_name['backups'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._BACKUP
...
_RESTORETABLEMETADATA.fields_by_name['source_type'].enum_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._RESTORESOURCETYPE
_RESTORETABLEMETADATA.fields_by_name['backup_info'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._BACKUPINFO
_RESTORETABLEMETADATA.fields_by_name['progress'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_common__pb2._OPERATIONPROGRESS
...
_OPTIMIZERESTOREDTABLEMETADATA.fields_by_name['progress'].message_type = google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_common__pb2._OPERATIONPROGRESS
...
ListTablesRequest = _reflection.GeneratedProtocolMessageType('ListTablesRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      view:
          ...
          NAME\_ONLY view (default) and REPLICATION\_VIEW are supported.
      page_size:
...
CreateBackupRequest = _reflection.GeneratedProtocolMessageType('CreateBackupRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      backup_id:
          ...
          {parent}/backups/{backup\_id} to create the full backup name,
...
CreateBackupMetadata = _reflection.GeneratedProtocolMessageType('CreateBackupMetadata', (_message.Message,), dict(
...
UpdateBackupRequest = _reflection.GeneratedProtocolMessageType('UpdateBackupRequest', (_message.Message,), dict(
...
DeleteBackupRequest = _reflection.GeneratedProtocolMessageType('DeleteBackupRequest', (_message.Message,), dict(
...
ListBackupsRequest = _reflection.GeneratedProtocolMessageType('ListBackupsRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      filter:
          ...
          "howl". -  ``source_table:prod`` --> The source\_table's name
          contains the    string "prod". -  ``state:CREATING`` --> The
          backup is pending creation. -  ``state:READY`` --> The backup
          is fully created and ready for use. -  ``(name:howl) AND
          (start_time < \"2018-03-28T14:50:00Z\")`` --> The    backup
          name contains the string "howl" and start\_time of the backup
          is before 2018-03-28T14:50:00Z. -  ``size_bytes >
      ...
      order_by:
          ...
          supported are: \* name \* source\_table \* expire\_time \*
          start\_time \* end\_time \* size\_bytes \* state  For example,
          "start\_time". The default sorting order is ascending. To
          specify descending order for the field, a suffix " desc"
          should be appended to the field name. For example,
          "start\_time desc". Redundant space characters in the syntax
          are insigificant.  If order\_by is empty, results will be
          sorted by ``start_time`` in descending order starting from the
      ...
      page_token:
          ...
          en][google.bigtable.admin.v2.ListBackupsResponse.next\_page\_t
          oken] from a previous [ListBackupsResponse][google.bigtable.ad
          min.v2.ListBackupsResponse] to the same ``parent`` and with
          the same ``filter``.
  """,
...
RestoreTableMetadata = _reflection.GeneratedProtocolMessageType('RestoreTableMetadata', (_message.Message,), dict(
...
OptimizeRestoredTableMetadata = _reflection.GeneratedProtocolMessageType('OptimizeRestoredTableMetadata', (_message.Message,), dict(
...
_BIGTABLETABLEADMIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002/\"*/v2/{parent=projects/*/instances/*}/tables:\001*\332A\025parent,table_id,table'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002B\"=/v2/{parent=projects/*/instances/*}/tables:createFromSnapshot:\001*\332A\037parent,table_id,source_snapshot\312A(\n\005Table\022\037CreateTableFromSnapshotMetadata'),
  ),
  _descriptor.MethodDescriptor(
    name='ListTables',
    ...
    serialized_options=_b('\202\323\344\223\002,\022*/v2/{parent=projects/*/instances/*}/tables\332A\006parent'),
  ),
  _descriptor.MethodDescriptor(
    name='GetTable',
    ...
    output_type=google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._TABLE,
    serialized_options=_b('\202\323\344\223\002,\022*/v2/{name=projects/*/instances/*/tables/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteTable',
    ...
    serialized_options=_b('\202\323\344\223\002,**/v2/{name=projects/*/instances/*/tables/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._TABLE,
    serialized_options=_b('\202\323\344\223\002D\"?/v2/{name=projects/*/instances/*/tables/*}:modifyColumnFamilies:\001*\332A\022name,modifications'),
  ),
  _descriptor.MethodDescriptor(
    name='DropRowRange',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002<\"7/v2/{name=projects/*/instances/*/tables/*}:dropRowRange:\001*'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002H\"C/v2/{name=projects/*/instances/*/tables/*}:generateConsistencyToken:\001*\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002@\";/v2/{name=projects/*/instances/*/tables/*}:checkConsistency:\001*\332A\026name,consistency_token'),
  ),
  _descriptor.MethodDescriptor(
    name='SnapshotTable',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\0028\"3/v2/{name=projects/*/instances/*/tables/*}:snapshot:\001*\332A$name,cluster,snapshot_id,description\312A!\n\010Snapshot\022\025SnapshotTableMetadata'),
  ),
  _descriptor.MethodDescriptor(
    name='GetSnapshot',
    ...
    serialized_options=_b('\202\323\344\223\002:\0228/v2/{name=projects/*/instances/*/clusters/*/snapshots/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    name='ListSnapshots',
    ...
    serialized_options=_b('\202\323\344\223\002:\0228/v2/{parent=projects/*/instances/*/clusters/*}/snapshots\332A\006parent'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteSnapshot',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002:*8/v2/{name=projects/*/instances/*/clusters/*/snapshots/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateBackup',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002@\"6/v2/{parent=projects/*/instances/*/clusters/*}/backups:\006backup\312A\036\n\006Backup\022\024CreateBackupMetadata\332A\027parent,backup_id,backup'),
  ),
  _descriptor.MethodDescriptor(
    name='GetBackup',
    ...
    output_type=google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._BACKUP,
    serialized_options=_b('\202\323\344\223\0028\0226/v2/{name=projects/*/instances/*/clusters/*/backups/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateBackup',
    ...
    output_type=google_dot_cloud_dot_bigtable_dot_admin__v2_dot_proto_dot_table__pb2._BACKUP,
    serialized_options=_b('\202\323\344\223\002G2=/v2/{backup.name=projects/*/instances/*/clusters/*/backups/*}:\006backup\332A\022backup,update_mask'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteBackup',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\0028*6/v2/{name=projects/*/instances/*/clusters/*/backups/*}\332A\004name'),
  ),
  _descriptor.MethodDescriptor(
    name='ListBackups',
    ...
    serialized_options=_b('\202\323\344\223\0028\0226/v2/{parent=projects/*/instances/*/clusters/*}/backups\332A\006parent'),
  ),
  _descriptor.MethodDescriptor(
    name='RestoreTable',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\0027\"2/v2/{parent=projects/*/instances/*}/tables:restore:\001*\312A\035\n\005Table\022\024RestoreTableMetadata'),
  ),
  _descriptor.MethodDescriptor(
    name='GetIamPolicy',
    ...
    serialized_options=_b('\202\323\344\223\002@\";/v2/{resource=projects/*/instances/*/tables/*}:getIamPolicy:\001*\332A\010resource'),
  ),
  _descriptor.MethodDescriptor(
    name='SetIamPolicy',
    ...
    output_type=google_dot_iam_dot_v1_dot_policy__pb2._POLICY,
    serialized_options=_b('\202\323\344\223\002\216\001\";/v2/{resource=projects/*/instances/*/tables/*}:setIamPolicy:\001*ZL\"G/v2/{resource=projects/*/instances/*/clusters/*/backups/*}:setIamPolicy:\001*\332A\017resource,policy'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\232\001\"A/v2/{resource=projects/*/instances/*/tables/*}:testIamPermissions:\001*ZR\"M/v2/{resource=projects/*/instances/*/clusters/*/backups/*}:testIamPermissions:\001*\332A\024resource,permissions'),
  ),
])
