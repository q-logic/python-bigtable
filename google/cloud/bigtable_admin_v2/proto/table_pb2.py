...
_RESTORESOURCETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='RESTORE_SOURCE_TYPE_UNSPECIFIED', index=0, number=0,
...
_TABLE_CLUSTERSTATE_REPLICATIONSTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='READY_OPTIMIZING', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_RESTOREINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='source_type', full_name='google.bigtable.admin.v2.RestoreInfo.source_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='backup_info', full_name='google.bigtable.admin.v2.RestoreInfo.backup_info', index=1,
...
_TABLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='restore_info', full_name='google.bigtable.admin.v2.Table.restore_info', index=4,
...
_BACKUP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.bigtable.admin.v2.Backup.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='source_table', full_name='google.bigtable.admin.v2.Backup.source_table', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='expire_time', full_name='google.bigtable.admin.v2.Backup.expire_time', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='start_time', full_name='google.bigtable.admin.v2.Backup.start_time', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.bigtable.admin.v2.Backup.end_time', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='size_bytes', full_name='google.bigtable.admin.v2.Backup.size_bytes', index=5,
      ...
      serialized_options=_b('\340A\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='google.bigtable.admin.v2.Backup.state', index=6,
...
_BACKUPINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='backup', full_name='google.bigtable.admin.v2.BackupInfo.backup', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='google.bigtable.admin.v2.BackupInfo.start_time', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.bigtable.admin.v2.BackupInfo.end_time', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_table', full_name='google.bigtable.admin.v2.BackupInfo.source_table', index=3,
...
_BACKUP.fields_by_name['start_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_BACKUPINFO.fields_by_name['start_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_BACKUPINFO.fields_by_name['end_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
RestoreInfo = _reflection.GeneratedProtocolMessageType('RestoreInfo', (_message.Message,), dict(
